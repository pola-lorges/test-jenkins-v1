...
test('Recherche produit limit @limit', async ({ page }) => { 
    ...
    //point de verification
    await expect(page.locator('#style_popular_product_wrapper__z6J0h')).toHaveText(product_data.valid_verification_check);
});